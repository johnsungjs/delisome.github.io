  ...
  return (
    <>
      <div className="w-full h-full px-6">
        <div className="flex gap-4 justify-start bg-abuMuda rounded-xl overflow-hidden">
          ...
          <div className="w-full">
            <div className="relative inline-block top-1/2 -translate-y-1/2 text-xs font-semibold">
